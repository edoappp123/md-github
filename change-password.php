...
$chngpwd1->execute();
$msg=" Anda berhasil ubah kata sandi";
}
else {
$error=" Anda memasukan kata sandi lama yang salah";	
}
}
?>
...
{
alert("Kata sandi baru dan konfirmasi kata sandi baru tidak sama, Harap masukan dengan sama !!");
			...
			<div class="container-fluid">
				...
				<div class="row">
						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Form ubah kata sandi</div>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>GAGAL</strong> :<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Konfirmasi ulang kata sandi baru</label>
												<div class="col-sm-8">
